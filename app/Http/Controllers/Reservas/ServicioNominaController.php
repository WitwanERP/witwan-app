...
class ServicioNominaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = ServicioNomina::create($data);
    ...
    {
        try {
            $item = ServicioNomina::findOrFail($id);
