...
use App\Models\Serviciofactura;
...
class ServiciofacturaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Serviciofactura::create($data);
    ...
    {
        try {
            $item = Serviciofactura::findOrFail($id);
