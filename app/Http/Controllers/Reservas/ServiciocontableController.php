...
use App\Models\Serviciocontable;
...
class ServiciocontableController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Serviciocontable::create($data);
    ...
    {
        try {
            $item = Serviciocontable::findOrFail($id);
