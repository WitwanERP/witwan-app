...
class FilecomentarioController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Filecomentario::create($data);
    ...
    {
        try {
            $item = Filecomentario::findOrFail($id);
