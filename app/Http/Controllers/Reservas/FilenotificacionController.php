...
use App\Models\Filenotificacion;
...
class FilenotificacionController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Filenotificacion::create($data);
    ...
    {
        try {
            $item = Filenotificacion::findOrFail($id);
