...
use App\Models\RelUsuariomodelocomision;
...
class RelUsuariomodelocomisionController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelUsuariomodelocomision::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelUsuariomodelocomision();
        ...
        $item = RelUsuariomodelocomision::create($data);
    ...
    {
        try {
            $item = RelUsuariomodelocomision::findOrFail($id);
