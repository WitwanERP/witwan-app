...
use App\Models\Vigenciaalojamiento;
...
class VigenciaalojamientoController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = Vigenciaalojamiento::query();
    ...
    public function store(Request $request)
    {
        ...
        $item = Vigenciaalojamiento::create($data);
    ...
    {
        try {
            $item = Vigenciaalojamiento::findOrFail($id);
