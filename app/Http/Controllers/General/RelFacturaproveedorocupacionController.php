...
class RelFacturaproveedorocupacionController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelFacturaproveedorocupacion::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelFacturaproveedorocupacion();
        ...
        $item = RelFacturaproveedorocupacion::create($data);
    ...
    {
        try {
            $item = RelFacturaproveedorocupacion::findOrFail($id);
