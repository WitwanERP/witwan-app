...
use App\Models\RelFacturareportebsp;
...
class RelFacturareportebspController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelFacturareportebsp::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelFacturareportebsp();
        ...
        $item = RelFacturareportebsp::create($data);
    ...
    {
        try {
            $item = RelFacturareportebsp::findOrFail($id);
