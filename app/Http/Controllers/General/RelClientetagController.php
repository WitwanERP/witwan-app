...
class RelClientetagController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelClientetag::create($data);
    ...
    {
        try {
            $item = RelClientetag::findOrFail($id);
