...
class RelPasajerotagController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelPasajerotag::create($data);
    ...
    {
        try {
            $item = RelPasajerotag::findOrFail($id);
