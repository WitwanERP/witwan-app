...
class RelFilefacturaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelFilefactura::create($data);
    ...
    {
        try {
            $item = RelFilefactura::findOrFail($id);
