...
use App\Models\Aeropuertociudad;
...
class AeropuertociudadController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Aeropuertociudad::create($data);
    ...
    {
        try {
            $item = Aeropuertociudad::findOrFail($id);
