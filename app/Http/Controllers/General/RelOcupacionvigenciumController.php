...
use App\Models\RelOcupacionvigencium;
...
class RelOcupacionvigenciumController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelOcupacionvigencium::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelOcupacionvigencium();
        ...
        $item = RelOcupacionvigencium::create($data);
    ...
    {
        try {
            $item = RelOcupacionvigencium::findOrFail($id);
