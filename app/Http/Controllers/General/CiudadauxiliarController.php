...
class CiudadauxiliarController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Ciudadauxiliar::create($data);
    ...
    {
        try {
            $item = Ciudadauxiliar::findOrFail($id);
