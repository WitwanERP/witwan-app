...
use App\Models\RelProductociudad;
...
class RelProductociudadController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelProductociudad::create($data);
    ...
    {
        try {
            $item = RelProductociudad::findOrFail($id);
