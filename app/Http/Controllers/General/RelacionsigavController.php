...
class RelacionsigavController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Relacionsigav::create($data);
    ...
    {
        try {
            $item = Relacionsigav::findOrFail($id);
