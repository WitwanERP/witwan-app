...
use App\Models\Programafidelidad;
...
class ProgramafidelidadController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Programafidelidad::create($data);
    ...
    {
        try {
            $item = Programafidelidad::findOrFail($id);
