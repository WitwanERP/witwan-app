...
use App\Models\RelProductoalojamientofacilidad;
...
class RelProductoalojamientofacilidadController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelProductoalojamientofacilidad::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelProductoalojamientofacilidad();
        ...
        $item = RelProductoalojamientofacilidad::create($data);
    ...
    {
        try {
            $item = RelProductoalojamientofacilidad::findOrFail($id);
