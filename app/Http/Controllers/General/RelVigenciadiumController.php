...
use App\Models\RelVigenciadium;
...
class RelVigenciadiumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelVigenciadium::create($data);
    ...
    {
        try {
            $item = RelVigenciadium::findOrFail($id);
