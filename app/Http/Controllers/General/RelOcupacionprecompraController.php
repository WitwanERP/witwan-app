...
use App\Models\RelOcupacionprecompra;
...
class RelOcupacionprecompraController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelOcupacionprecompra::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelOcupacionprecompra();
        ...
        $item = RelOcupacionprecompra::create($data);
    ...
    {
        try {
            $item = RelOcupacionprecompra::findOrFail($id);
