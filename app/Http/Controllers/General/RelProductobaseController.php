...
use App\Models\RelProductobase;
...
class RelProductobaseController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelProductobase::create($data);
    ...
    {
        try {
            $item = RelProductobase::findOrFail($id);
