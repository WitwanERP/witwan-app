...
class TipoclavefiscalController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Tipoclavefiscal::create($data);
    ...
    {
        try {
            $item = Tipoclavefiscal::findOrFail($id);
