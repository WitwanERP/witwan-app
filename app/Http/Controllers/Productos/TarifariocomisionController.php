...
use App\Models\Tarifariocomision;
...
class TarifariocomisionController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Tarifariocomision::create($data);
    ...
    {
        try {
            $item = Tarifariocomision::findOrFail($id);
