...
use App\Models\Tarifacategorium;
...
class TarifacategoriumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Tarifacategorium::create($data);
    ...
    {
        try {
            $item = Tarifacategorium::findOrFail($id);
