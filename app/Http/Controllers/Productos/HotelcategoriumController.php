...
use App\Models\Hotelcategorium;
...
class HotelcategoriumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Hotelcategorium::create($data);
    ...
    {
        try {
            $item = Hotelcategorium::findOrFail($id);
