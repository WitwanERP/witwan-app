...
class AlojamientotipoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Alojamientotipo::create($data);
    ...
    {
        try {
            $item = Alojamientotipo::findOrFail($id);
