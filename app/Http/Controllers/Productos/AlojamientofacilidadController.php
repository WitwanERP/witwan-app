...
use App\Models\Alojamientofacilidad;
...
class AlojamientofacilidadController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = Alojamientofacilidad::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new Alojamientofacilidad();
        ...
        $item = Alojamientofacilidad::create($data);
    ...
    {
        try {
            $item = Alojamientofacilidad::findOrFail($id);
