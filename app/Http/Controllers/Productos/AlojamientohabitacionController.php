...
use App\Models\Alojamientohabitacion;
...
class AlojamientohabitacionController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = Alojamientohabitacion::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new Alojamientohabitacion();
        ...
        $item = Alojamientohabitacion::create($data);
    ...
    {
        try {
            $item = Alojamientohabitacion::findOrFail($id);
