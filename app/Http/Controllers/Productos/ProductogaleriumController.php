...
use App\Models\Productogalerium;
...
class ProductogaleriumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Productogalerium::create($data);
    ...
    {
        try {
            $item = Productogalerium::findOrFail($id);
