...
use App\Models\Tarifarioarchivo;
...
class TarifarioarchivoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Tarifarioarchivo::create($data);
    ...
    {
        try {
            $item = Tarifarioarchivo::findOrFail($id);
