...
class CupohistorialController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Cupohistorial::create($data);
    ...
    {
        try {
            $item = Cupohistorial::findOrFail($id);
