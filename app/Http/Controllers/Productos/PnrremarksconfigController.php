...
use App\Models\Pnrremarksconfig;
...
class PnrremarksconfigController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Pnrremarksconfig::create($data);
    ...
    {
        try {
            $item = Pnrremarksconfig::findOrFail($id);
