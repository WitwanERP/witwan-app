...
class CadenaclienteController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Cadenacliente::create($data);
    ...
    {
        try {
            $item = Cadenacliente::findOrFail($id);
