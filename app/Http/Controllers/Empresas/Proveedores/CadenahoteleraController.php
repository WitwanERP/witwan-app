...
namespace App\Http\Controllers\Empresas\Proveedores;
...
class CadenahoteleraController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Cadenahotelera::create($data);
    ...
    {
        try {
            $item = Cadenahotelera::findOrFail($id);
