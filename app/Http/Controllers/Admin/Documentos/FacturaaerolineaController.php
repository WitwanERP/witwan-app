...
use App\Models\Facturaaerolinea;
...
class FacturaaerolineaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Facturaaerolinea::create($data);
    ...
    {
        try {
            $item = Facturaaerolinea::findOrFail($id);
