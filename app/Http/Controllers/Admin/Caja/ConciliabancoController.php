...
class ConciliabancoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Conciliabanco::create($data);
    ...
    {
        try {
            $item = Conciliabanco::findOrFail($id);
