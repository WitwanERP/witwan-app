...
class ModelocomisionController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Modelocomision::create($data);
    ...
    {
        try {
            $item = Modelocomision::findOrFail($id);
