...
class NubeanaliticoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Nubeanalitico::create($data);
    ...
    {
        try {
            $item = Nubeanalitico::findOrFail($id);
