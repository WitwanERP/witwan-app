...
class CiudadtouricoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Ciudadtourico::create($data);
    ...
    {
        try {
            $item = Ciudadtourico::findOrFail($id);
