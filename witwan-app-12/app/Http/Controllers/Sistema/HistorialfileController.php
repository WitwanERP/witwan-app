...
class HistorialfileController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Historialfile::create($data);
    ...
    {
        try {
            $item = Historialfile::findOrFail($id);
