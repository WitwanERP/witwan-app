...
use App\Models\Servicioasociado;
...
class ServicioasociadoController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Servicioasociado::create($data);
    ...
    {
        try {
            $item = Servicioasociado::findOrFail($id);
