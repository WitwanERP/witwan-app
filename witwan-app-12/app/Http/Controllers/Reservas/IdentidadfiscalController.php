...
use App\Models\Identidadfiscal;
...
class IdentidadfiscalController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Identidadfiscal::create($data);
    ...
    {
        try {
            $item = Identidadfiscal::findOrFail($id);
