...
class InterfasedatumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Interfasedatum::create($data);
    ...
    {
        try {
            $item = Interfasedatum::findOrFail($id);
