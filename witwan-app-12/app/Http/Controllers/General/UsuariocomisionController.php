...
use App\Models\Usuariocomision;
...
class UsuariocomisionController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Usuariocomision::create($data);
    ...
    {
        try {
            $item = Usuariocomision::findOrFail($id);
