...
use App\Models\RelOrdenadminocupacion;
...
class RelOrdenadminocupacionController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelOrdenadminocupacion::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelOrdenadminocupacion();
        ...
        $item = RelOrdenadminocupacion::create($data);
    ...
    {
        try {
            $item = RelOrdenadminocupacion::findOrFail($id);
