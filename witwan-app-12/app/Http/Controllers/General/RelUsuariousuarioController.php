...
use App\Models\RelUsuariousuario;
...
class RelUsuariousuarioController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelUsuariousuario::create($data);
    ...
    {
        try {
            $item = RelUsuariousuario::findOrFail($id);
