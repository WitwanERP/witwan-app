...
use App\Models\Autorizacionpnr;
...
class AutorizacionpnrController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Autorizacionpnr::create($data);
    ...
    {
        try {
            $item = Autorizacionpnr::findOrFail($id);
