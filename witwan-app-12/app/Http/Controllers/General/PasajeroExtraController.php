...
class PasajeroExtraController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = PasajeroExtra::create($data);
    ...
    {
        try {
            $item = PasajeroExtra::findOrFail($id);
