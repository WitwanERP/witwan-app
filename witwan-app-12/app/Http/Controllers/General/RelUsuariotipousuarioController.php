...
use App\Models\RelUsuariotipousuario;
...
class RelUsuariotipousuarioController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelUsuariotipousuario::query();
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $model = new RelUsuariotipousuario();
        ...
        $item = RelUsuariotipousuario::create($data);
    ...
    {
        try {
            $item = RelUsuariotipousuario::findOrFail($id);
