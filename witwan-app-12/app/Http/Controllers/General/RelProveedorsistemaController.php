...
use App\Models\RelProveedorsistema;
...
class RelProveedorsistemaController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelProveedorsistema::query();
    ...
    public function store(Request $request)
    {
        ...
        $item = RelProveedorsistema::create($data);
    ...
    {
        try {
            $item = RelProveedorsistema::findOrFail($id);
