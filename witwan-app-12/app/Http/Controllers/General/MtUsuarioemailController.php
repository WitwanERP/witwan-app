...
class MtUsuarioemailController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = MtUsuarioemail::create($data);
    ...
    {
        try {
            $item = MtUsuarioemail::findOrFail($id);
