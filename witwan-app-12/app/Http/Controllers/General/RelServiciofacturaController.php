...
use App\Models\RelServiciofactura;
...
class RelServiciofacturaController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $query = RelServiciofactura::query();
    ...
    public function store(Request $request)
    {
        ...
        $item = RelServiciofactura::create($data);
    ...
    {
        try {
            $item = RelServiciofactura::findOrFail($id);
