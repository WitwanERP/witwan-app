...
class RelGuiaidiomaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelGuiaidioma::create($data);
    ...
    {
        try {
            $item = RelGuiaidioma::findOrFail($id);
