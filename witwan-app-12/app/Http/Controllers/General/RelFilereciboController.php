...
class RelFilereciboController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelFilerecibo::create($data);
    ...
    {
        try {
            $item = RelFilerecibo::findOrFail($id);
