...
use App\Models\RelGrupopaispai;
...
class RelGrupopaispaiController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = RelGrupopaispai::create($data);
    ...
    {
        try {
            $item = RelGrupopaispai::findOrFail($id);
