...
class FacturaboletumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Facturaboletum::create($data);
    ...
    {
        try {
            $item = Facturaboletum::findOrFail($id);
