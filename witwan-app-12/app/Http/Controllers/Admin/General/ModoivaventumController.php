...
class ModoivaventumController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Modoivaventum::create($data);
    ...
    {
        try {
            $item = Modoivaventum::findOrFail($id);
