...
namespace App\Http\Controllers\Admin\BSP;

use App\Models\Reportebsptkt;
...
class ReportebsptktController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $item = Reportebsptkt::create($data);
    ...
    {
        try {
            $item = Reportebsptkt::findOrFail($id);
